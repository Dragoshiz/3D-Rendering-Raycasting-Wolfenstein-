...
/*   Updated: 2023/01/30 11:04:04 by dimbrea          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "inc/cub3d.h"

//function used to debug the program
//casts 1 ray 
...
//returns the color of texture's each pixel and if reaches 
//the texture's width or height starts from 0 again
...
//part 1 of function that checks wheter the wall that's been hit is facing NSEW
