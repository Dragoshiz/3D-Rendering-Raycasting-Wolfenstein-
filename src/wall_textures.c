...
/*   Updated: 2023/01/30 11:15:57 by dimbrea          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "inc/cub3d.h"

// function that returns the texture's pixel color and if ray
// has hit a East or West facing wall changes the y and x 
// stays as it was received otherwise x gets changed and y 
// stays as received
...
//function that when wall is hit draws the wall based on the ray's distance
