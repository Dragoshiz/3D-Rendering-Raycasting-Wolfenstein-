...
/*   Updated: 2023/01/30 10:56:41 by dimbrea          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// this function is used together with mlx_loop_hook()
// and it loops constantly
...
// if called puts a red pixel as the player on the image
...
//gets the size of the map based on the number of rows and columns
// also calculates width and height of each "square"
